...
public class suimono_modulefx_editor : Editor {
    ...
    Undo.RecordObject(target, "Changed Area Of Effect");
		...
		//bgPresetNd  = Resources.Load("textures/gui_bgpresetNd") as Texture;
			...
			logoTex = Resources.Load("textures/gui_tex_suimonologofxsys_i") as Texture;
		...
		if (script.effectsSystems.Length <= 0){
			EditorGUI.LabelField(new Rect(rt.x+margin+50, rt.y+35, 387, 18),"THERE ARE CURRENTLY NO FX SYSTMS...");
